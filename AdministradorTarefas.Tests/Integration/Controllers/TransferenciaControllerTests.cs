using AdministradorTarefas.Application.DTOs.Transferencia;
using AdministradorTarefas.Tests.Helpers;
using FluentAssertions;
using System.Net;
using System.Net.Http.Json;

namespace AdministradorTarefas.Tests.Integration.Controllers;
